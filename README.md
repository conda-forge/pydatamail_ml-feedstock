...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pydatamail_ml-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pydatamail_ml-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pydatamail_ml
# for installing globally
pixi global install pydatamail_ml
```
...
It is possible to list all of the versions of `pydatamail_ml` available on your platform:
...
```
pixi search pydatamail_ml --channel conda-forge
```
